...
#ifndef untEditaFichaPilH
#define untEditaFichaPilH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TfrmEditaFichaPil : public TForm
{
...
public:		// User declarations
	__fastcall TfrmEditaFichaPil(TComponent* Owner);
    int codFichaPil;
	int codClientePil;
    int janela;
};
//---------------------------------------------------------------------------
extern PACKAGE TfrmEditaFichaPil *frmEditaFichaPil;
//---------------------------------------------------------------------------
#endif
