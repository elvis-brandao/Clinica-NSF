...
#ifndef untFiltroFichaPalmilhaH
#define untFiltroFichaPalmilhaH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TfrmFiltroFichaPalmilha : public TForm
{
...
public:		// User declarations
	__fastcall TfrmFiltroFichaPalmilha(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TfrmFiltroFichaPalmilha *frmFiltroFichaPalmilha;
//---------------------------------------------------------------------------
#endif
